...
const repaintBodiHalus = [
    ...
    { model: "nouvo", aliases: ["yamaha nouvo", "nouvo z", "nouvo elegance"], price: 900000, note: "Full Body Halus", brand: "yamaha" },
    { model: "vario 110", aliases: ["honda vario 110", "vario karbu", "vario techno 110"], price: 800000, note: "Full Body Halus", brand: "honda" },
    { model: "vario 125", aliases: ["honda vario", "vario 125", "honda vario 125"], price: 900000, note: "Full Body Halus", brand: "honda" },
    { model: "vario 150/160", aliases: ["vario 150", "vario 160", "honda vario 150", "honda vario 160"], price: 1000000, note: "Full Body Halus", brand: "honda" },
    ...
    { model: "nmax", aliases: ["yamaha nmax", "n-max"], price: 1000000, note: "Full Body Halus", brand: "yamaha" },
    { model: "pcx", aliases: ["honda pcx", "pcx 150", "pcx 160"], price: 1100000, note: "Full Body Halus", brand: "honda" },
    { model: "adv", aliases: ["honda adv", "adv 150", "adv 160"], price: 1100000, note: "Full Body Halus", brand: "honda" },
    { model: "aerox", aliases: ["yamaha aerox"], price: 1000000, note: "Full Body Halus", brand: "yamaha" },
    { model: "satria fu", aliases: ["suzuki satria f150", "satria f"], price: 900000, note: "Full Body Halus", brand: "suzuki" },
    { model: "mx king", aliases: ["yamaha mx king", "mx king 150"], price: 800000, note: "Full Body Halus", brand: "yamaha" },
    { model: "lexi", aliases: ["yamaha lexi"], price: 900000, note: "Full Body Halus", brand: "yamaha" },
    { model: "jupiter mx", aliases: ["yamaha jupiter mx", "mx 135"], price: 800000, note: "Full Body Halus", brand: "yamaha" },
    { model: "vespa", aliases: ["vespa lx", "vespa s", "vespa sprint", "vespa primavera", "vespa gts", "vespa klasik", "vespa px"], price: 1500000, note: "Full Body Halus", brand: "vespa" },
    { model: "sonic", aliases: ["honda sonic", "sonic 150r"], price: 900000, note: "Full Body Halus", brand: "honda" },
    { model: "supra gtr 150", aliases: ["honda supra gtr", "gtr 150"], price: 900000, note: "Full Body Halus", brand: "honda" },
    { model: "gesits", aliases: ["gesits g1"], price: 1000000, note: "Full Body Halus", brand: "ev" },
    { model: "alva one", aliases: ["alva"], price: 1100000, note: "Full Body Halus", brand: "ev" },
    { model: "alva cervo", aliases: [], price: 1100000, note: "Full Body Halus", brand: "ev" },
    { model: "united t1800", aliases: ["united"], price: 1100000, note: "Full Body Halus", brand: "ev" },
    { model: "polytron t-rex", aliases: ["polytron fox r"], price: 1100000, note: "Full Body Halus", brand: "ev" },
    { model: "viar e-cross", aliases: ["viar ecross"], price: 1000000, note: "Full Body Halus", brand: "ev" },
    { model: "w175", aliases: ["kawasaki w175"], price: 1000000, note: "Full Body Halus", brand: "kawasaki" },

    // ─── BODY 3: Sport & Fairing ───
    { model: "cbr", aliases: ["honda cbr", "cbr 150r", "cbr150r", "cbr 250rr", "cbr250rr"], price: 1200000, note: "Full Body Halus", brand: "honda" },
    { model: "vixion", aliases: ["yamaha vixion", "v-ixion"], price: 1200000, note: "Full Body Halus", brand: "yamaha" },
    { model: "r15", aliases: ["yamaha r15"], price: 1200000, note: "Full Body Halus", brand: "yamaha" },
    { model: "r25", aliases: ["yamaha r25"], price: 1400000, note: "Full Body Halus", brand: "yamaha" },
    { model: "mt-15", aliases: ["yamaha mt-15", "mt15"], price: 1200000, note: "Full Body Halus", brand: "yamaha" },
    { model: "mt-25", aliases: ["yamaha mt-25", "mt25"], price: 1300000, note: "Full Body Halus", brand: "yamaha" },
    { model: "xabre", aliases: ["yamaha xabre"], price: 1200000, note: "Full Body Halus", brand: "yamaha" },
    { model: "gsx-r150", aliases: ["suzuki gsx-r150", "gsxr150"], price: 1200000, note: "Full Body Halus", brand: "suzuki" },
    { model: "gsx-s150", aliases: ["suzuki gsx-s150", "gsxs150"], price: 1200000, note: "Full Body Halus", brand: "suzuki" },
    { model: "ninja", aliases: ["kawasaki ninja", "ninja 250", "ninja fi", "ninja karbu", "ninja 250 sl", "ninja rr mono", "zx25r"], price: 1500000, note: "Full Body Halus", brand: "kawasaki" },
    { model: "tiger", aliases: ["honda tiger", "tiger revo", "gl pro", "gl max"], price: 1200000, note: "Full Body Halus (Termasuk Tangki)", brand: "honda" },
    { model: "thunder 125", aliases: ["suzuki thunder"], price: 1200000, note: "Full Body Halus (Termasuk Tangki)", brand: "suzuki" },
    { model: "xsr 155", aliases: ["yamaha xsr"], price: 1200000, note: "Full Body Halus", brand: "yamaha" },
    { model: "cb 150r", aliases: ["honda cb 150r", "cb150r", "cb150 streetfire"], price: 1000000, note: "Full Body Halus", brand: "honda" },
    { model: "verza", aliases: ["honda verza", "cb150 verza"], price: 1000000, note: "Full Body Halus", brand: "honda" },
    { model: "megapro", aliases: ["honda megapro", "mega pro"], price: 1200000, note: "Full Body Halus", brand: "honda" },
    { model: "byson", aliases: ["yamaha byson"], price: 1100000, note: "Full Body Halus", brand: "yamaha" },
